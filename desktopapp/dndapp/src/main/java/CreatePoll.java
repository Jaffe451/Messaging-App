...
public class CreatePoll {
	...
	public CreatePoll(Home home, String list) {
		mw = home;
		thePoll = list; 
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblListName = new JLabel("Poll Name");
		...
		if(!thePoll.equals("")) {
			list.setModel(mod);
			String[] listElements = thePoll.split(",");
